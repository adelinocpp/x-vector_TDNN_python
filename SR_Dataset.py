...
from DB_wav_reader import find_save_models
...
def get_min_loss_model(log_dir):
    start = 1 # Start epoch
    save_model_file_list = find_save_models(log_dir)
...
def read_MFB(filename):
    ...
    if (feature.shape[0] <  c.NUM_WIN_SIZE):
...
# def main():
    ...
    # train_DB = read_DB_structure(c.TRAIN_WAV_DIR)
